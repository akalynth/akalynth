...
> **ARCHIVED (2026-05-30).** Both deliverables shipped (mmo-site PR #75; mob-loot id fix PR #81, commit `1aff123`). This is a completed-work evidence log, not an active runbook. Kept for history. **Note (2026-06-01):** `mmo-site/` has since been retired from the monorepo; see `docs/archive/SITE_RETIRED_FROM_MONOREPO.md`.
