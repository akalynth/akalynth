...
- [Risk & Consequence Spine Decision](./decisions/AKALYNTH_RISK_CONSEQUENCE_AND_COMMITMENT_V1/DECISION.md) - accepted design decision for durable risk, recovery, standing contexts, ECE/RCE/MCE, CRB, coupled outcomes, and receipt evidence; partial server-private implementation lineage is recorded separately, with no gameplay activation, conformance, or release claim
