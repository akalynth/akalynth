...
- Root `npm run verify:account-character`: focused account-character parity
  gate. Runs protocol sync, server account-character tests, server shop/work/property gameplay route proof, debug-client guard, Android account-character unit tests, and Android character UI compile.
