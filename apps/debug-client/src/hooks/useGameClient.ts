        ...
        setState((s) => {
          ...
          switch (data.type) {
            ...
            case 'skill_result': {
              ...
              if (skillId.startsWith('route:survey:') || skillId === 'route:quest:shipment' || skillId === 'route:economy:forgehold' || skillId === 'route:craft:soulsteel' || skillId === 'route:dream:interpret' || skillId === 'route:dream:fragment') {
