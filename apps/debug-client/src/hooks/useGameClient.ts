        ...
        setState((s) => {
          ...
          switch (data.type) {
            ...
            case 'skill_result': {
              ...
              if (skillId.startsWith('route:survey:') || skillId.startsWith('route:safety:') || skillId === 'route:quest:shipment' || skillId === 'route:economy:forgehold' || skillId.startsWith('route:craft:') || skillId.startsWith('route:gate:') || skillId === 'route:dream:interpret' || skillId === 'route:dream:fragment') {
