...
The cross-tool project guide (skills, operating posture, release process) is in
...
`~/.claude/skills/` with `./scripts/sync-claude-continue-skill.sh`.

@AGENTS.md
@.claude/skills/akalynth-continue/references/CONTINUATION_STATE.md
