 ...
 */
export function getEvidence(ctx, req) {
 ...
 */
function reconstructItemLostEvidence(ctx, event) {
    ...
    const explanation = explainDeathDrops(inventorySnapshot, zone, reputation, death.receipt_hash, heatLookup);
 ...
 */
function reconstructDeathEvidence(ctx, event) {
 ...
 */
function toDropExplanationWire(explanation) {
    return {
        policy: {
