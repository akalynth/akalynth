 ...
 */
export function buildProofBundle(options) {
    ...
    // Build identifiers
    const identifiers = {
        bundle_id: generateBundleId(options.receipt?.receipt_id ?? event_id, created_at_ms),
        event_id,
 ...
 */
export function generateBundleId(seed, timestamp_ms) {
 ...
 */
function buildCanonicalContent(bundle) {
    const parts = [];
