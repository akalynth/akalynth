...
// Friction Actions
// ============================================================================
export const FRICTION_DEBIT_ACTION = 'friction_debit';
export const FRICTION_CREDIT_ACTION = 'friction_credit';
export const FRICTION_CONSTRAINT_APPLIED_ACTION = 'friction_constraint_applied';
// ============================================================================
// In-Memory Friction State
// ============================================================================
const frictionBalances = new Map();
const frictionConstraints = new Map();
// ============================================================================
// Balance Management
// ============================================================================
/**
 ...
 */
export function registerFrictionConstraint(constraint) {
    frictionConstraints.set(constraint.action, constraint);
}
/**
 * Get friction cost for an action
 */
export function getFrictionCost(action, inputs = {}) {
 ...
 */
export async function creditFriction(actor_id, amount, reason, audit, credited_by = 'system') {
    if (amount <= 0)
 ...
 */
export async function debitFriction(actor_id, amount, reason, audit, debited_by = 'system') {
    if (amount <= 0)
 ...
 */
export async function applyFrictionConstraint(actor, action, inputs, audit) {
    ...
    const debitResult = await debitFriction(actor.id, cost, `friction_cost:${action}`, audit);
 ...
 */
export function applyFrictionReceipt(receipt) {
 ...
 */
export function clearFrictionState() {
