...
Use this skill when turning a request into a task that another human or Codex lane can execute. Keep the issue decision-complete before marking it ready.

Rules:

- Split broad work by authority boundary: runtime, protocol, infra, Codex/plugin, docs, test, or audit.
...
- `state:delegated`: task has an owner or Codex lane.
