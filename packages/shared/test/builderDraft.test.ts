...
import type { BuilderDraftManifest } from '../builderDraft.js';
...
const previewSession = JSON.parse(readFileSync(preview, 'utf8')) as { artifacts: { manifest_checksum: string } };
...
check(
  'computeManifestChecksum matches preview fixture',
  computeManifestChecksum(manifest) === previewSession.artifacts.manifest_checksum,
);
