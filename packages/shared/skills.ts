...
export const FORGEHOLD_CARAVAN_EVENT_ID = 'forgehold_caravan_evidence';
export const FORGEHOLD_CARAVAN_GUARD_DECISION_ACTION = 'forgehold_caravan_guard_decision';
export const FORGEHOLD_CARAVAN_ACTIVITY_ID = 'forgehold_caravan_protection_v1';
export const FORGEHOLD_CARAVAN_GUARD_ID = 'npc:forgehold:caravan_guard';
export const FORGEHOLD_CARAVAN_MERCHANT_ARRIVED_ACTION = 'forgehold_caravan_merchant_arrived';
export const FORGEHOLD_CARAVAN_MERCHANT_ID = 'npc:forgehold:merchant_lora';
export const FORGEHOLD_CARAVAN_MERCHANT_TRAVEL_MS = 24 * 60 * 60 * 1000;
