 ...
 */
export function deriveAuthSeed(chronicleSeed: Uint8Array): Uint8Array {
 ...
 */
export function deriveAuthKeyPair(chronicleSeed: Uint8Array): {
 ...
 */
export function loadAuthKeyPair(keyPath?: string): {
  privateKey: crypto.KeyObject;
  publicKey: crypto.KeyObject;
  publicKeyHex: string;
} {
 ...
 */
export function getAuthKeyDomain(): string {
