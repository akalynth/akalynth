 ...
 */
export function validate(impl: WitnessImplementation): ConformanceResult {
 ...
 */
export function validateWitnessLite(impl: WitnessImplementation): ConformanceResult {
 ...
 */
export function validateWitnessStandard(impl: WitnessImplementation): ConformanceResult {
  const checks: CheckResult[] = [];
  const warnings: string[] = [];
 ...
 */
export function validateWitnessFull(impl: WitnessImplementation): ConformanceResult {
  const checks: CheckResult[] = [];
  const warnings: string[] = [];
...
function checkEventRequiredFields(impl: WitnessImplementation): CheckResult {
...
function checkEventStatusValues(impl: WitnessImplementation): CheckResult {
...
function checkEventSourceValues(impl: WitnessImplementation): CheckResult {
...
function checkExplanationRuleCitations(impl: WitnessImplementation): CheckResult {
...
function checkExplanationEvidenceRefs(impl: WitnessImplementation): CheckResult {
...
function checkJsonExport(impl: WitnessImplementation): CheckResult {
...
function checkSnapshotCapability(impl: WitnessImplementation): CheckResult {
...
function checkSnapshotSequence(impl: WitnessImplementation): CheckResult {
...
function checkSnapshotStateHash(impl: WitnessImplementation): CheckResult {
...
function checkProofBundleCapability(impl: WitnessImplementation): CheckResult {
...
function checkProofBundleIntegrity(impl: WitnessImplementation): CheckResult {
...
function checkDeterministicHashing(impl: WitnessImplementation): CheckResult {
...
function checkBundleVerification(impl: WitnessImplementation): CheckResult {
...
function checkForkCapability(impl: WitnessImplementation): CheckResult {
...
function checkForkValidationCapability(impl: WitnessImplementation): CheckResult {
...
function checkIsolationInvariant1(impl: WitnessImplementation): CheckResult {
  ...
  try {
    ...
    const simulatedEntry: ForkEntryData = {
      sequence: 2,
      event: {
        event_id: 'sim_test_1',
        action_id: null,
...
function checkIsolationInvariant2(impl: WitnessImplementation): CheckResult {
...
function checkIsolationInvariant3(impl: WitnessImplementation): CheckResult {
...
function checkIsolationInvariant4(impl: WitnessImplementation): CheckResult {
...
function checkIsolationInvariant5(impl: WitnessImplementation): CheckResult {
...
function checkViolationRaisesError(impl: WitnessImplementation): CheckResult {
